...
public class ResumeTestData {
    ...
    static {
        ...
        resume_1.setContact(ContactType.SKYPE, "skype:grigory.kislin");
        resume_1.setContact(ContactType.EMAIL, "gkislin@yandex.ru");
        resume_1.setContact(ContactType.LINKEDIN_PROFILE, "https://www.linkedin.com/in/gkislin");
        resume_1.setContact(ContactType.GITHUB_PROFILE, "https://github.com/gkislin");
        resume_1.setContact(ContactType.STACKOVERFLOW_PROFILE, "https://stackoverflow.com/users/548473");
        resume_1.setContact(ContactType.HOMEPAGE, "http://gkislin.ru/");

        resume_1.setSection(SectionType.OBJECTIVE, new SimpleLineSection("Ведущий стажировок и корпоративного" +
                " обучения по Java Web и Enterprise технологиям"));
        resume_1.setSection(SectionType.PERSONAL, new SimpleLineSection("Аналитический склад ума, сильная " +
                "логика, креативность, инициативность. Пурист кода и архитектуры."));
        resume_1.setSection(SectionType.ACHIEVEMENT, new BulletedListSection(List.of(
        ...
        resume_1.setSection(SectionType.QUALIFICATIONS, new BulletedListSection(List.of(
                "•\tJEE AS: GlassFish (v2.1, v3), OC4J, JBoss, Tomcat, Jetty, WebLogic, WSO2;"
                , "•\tVersion control: Subversion, Git, Mercury, ClearCase, Perforce"
        )));
        resume_1.setSection(SectionType.EXPERIENCE, new ListExperience(List.of(new Experience(
                "Enkata"
                , "http://enkata.com/"
                , List.of(new Period(LocalDate.of(2007, 3, 1), LocalDate.of(2008, 6, 1) , "Разработчик ПО"
        ...
        resume_1.setSection(SectionType.EDUCATION, new ListExperience(List.of(new Experience(
                "Luxoft"
    ...
    public static void main(String[] args) {
        for (ContactType type : ContactType.values()) {
            System.out.println(type.getTitle() + " " + resume_1.getContact(type));
        }
        for (SectionType type : SectionType.values()) {
            System.out.println(type.getTitle() + "\n" + resume_1.getSection(type));
            System.out.println();
        }
    }
}
